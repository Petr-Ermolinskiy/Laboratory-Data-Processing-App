...
class ColorPicker(QDialog):
    ...
    def __init__(self, lightTheme: bool = True, useAlpha: bool = False):
        ...
        self.setWindowTitle("Выберите цвет. После выбора ряда цветов не зубудьте убрать последний <&>")
...
def getColor(light: bool, lc: tuple = None) -> tuple:
