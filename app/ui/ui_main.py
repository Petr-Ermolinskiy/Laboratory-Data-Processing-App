...
"}")
        ...
        sizePolicy19.setHeightForWidth(self.scrollArea_2.sizePolicy().hasHeightForWidth())
        self.scrollArea_2.setSizePolicy(sizePolicy19)
        self.scrollArea_2.setMinimumSize(QSize(0, 255))
        self.scrollArea_2.setMaximumSize(QSize(16777215, 800))
