...
Если вы используете Windows, то вам дополнительно нужно будет скачать и установить **GTK3 Runtime**. 
Это нужно для библиотеки `weasyprint`.
Файл для установки можно найти по ссылке: https://github.com/tschoonj/GTK-for-Windows-Runtime-Environment-Installer/releases
