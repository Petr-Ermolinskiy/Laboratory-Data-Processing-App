# Документация приложения Lab App v3.7.8
...
<a id="w19"></a>
<b>19. check_patient_name_from_file_name</b> (QCheckBox)<br>
<html><head/><body><p>Возможность выбирать: имя пациента/образца берется из файла или из названия файла. По дефолту из файла.</p></body></html><br><br>

<a id="w20"></a>
<b>20. separator_for_data</b> (QLineEdit)<br>
...
<a id="w22"></a>
<b>22. check_stress</b> (QCheckBox)<br>
...
<a id="w23"></a>
<b>23. check_deform</b> (QCheckBox)<br>
...
<a id="w24"></a>
<b>24. check_dop_CSS_parameter</b> (QCheckBox)<br>
...
<a id="w25"></a>
<b>25. path_for_biola</b> (QLineEdit)<br>
...
<a id="w26"></a>
<b>26. comboBox_biola</b> (QComboBox)<br>
...
<a id="w27"></a>
<b>27. comboBox_biola_concentration</b> (QComboBox)<br>
...
<a id="w28"></a>
<b>28. spinBox_biola_born_odd</b> (QSpinBox)<br>
...
<a id="w29"></a>
<b>29. spinBox_biola_fluc_odd</b> (QSpinBox)<br>
...
<a id="w30"></a>
<b>30. spinBox_biola_born</b> (QSpinBox)<br>
...
<a id="w31"></a>
<b>31. spinBox_biola_fluc</b> (QSpinBox)<br>
...
<a id="w32"></a>
<b>32. check_biola_plot_figs</b> (QCheckBox)<br>
...
<a id="w33"></a>
<b>33. doubleSpinBox_Biola</b> (QDoubleSpinBox)<br>
Относительный размер шрифта<br><br>

<a id="w34"></a>
<b>34. comboBox_Biola_SD_or</b> (QComboBox)<br>
Погрешности на графиках<br><br>

<a id="w35"></a>
<b>35. check_setka_biola</b> (QCheckBox)<br>
Сделать сетку на графиках?<br><br>

<a id="w36"></a>
<b>36. comboBox_Biola_language</b> (QComboBox)<br>
Язык для графиков<br><br>

<a id="w37"></a>
<b>37. btn_biola</b> (QPushButton)<br>
Обработать данные из txt файла<br><br>

<a id="w38"></a>
<b>38. btn_biola_concentration</b> (QPushButton)<br>
...
<a id="w39"></a>
<b>39. path_for_LT</b> (QLineEdit)<br>
...
<a id="w40"></a>
<b>40. sep_for_LT</b> (QLineEdit)<br>
...
<a id="w42"></a>
<b>42. sep_for_LT_values</b> (QLineEdit)<br>
...
<a id="w43"></a>
<b>43. comboBox_LT_calibration</b> (QComboBox)<br>
...
<a id="w44"></a>
<b>44. btn_LT</b> (QPushButton)<br>
Произвести обработку данных для лазерного пинцета<br><br>

<a id="w45"></a>
<b>45. check_LT_raw_data</b> (QCheckBox)<br>
...
<a id="w52"></a>
<b>52. checkBox_point_comma_separator</b> (QCheckBox)<br>
Разделитель значений на графике запятая?<br><br>

<a id="w53"></a>
<b>53. check_box_plot</b> (QCheckBox)<br>
...
<a id="w54"></a>
<b>54. check_corr_matrix</b> (QCheckBox)<br>
...
<a id="w55"></a>
<b>55. check_corr_figs</b> (QCheckBox)<br>
...
<a id="w56"></a>
<b>56. check_box_pairplot</b> (QCheckBox)<br>
...
<a id="w57"></a>
<b>57. check_jointplot</b> (QCheckBox)<br>
...
<a id="w58"></a>
<b>58. check_corr_one_parameter</b> (QCheckBox)<br>
...
<a id="w59"></a>
<b>59. comboBox_color_pal_box</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для box</p></body></html><br><br>

<a id="w60"></a>
<b>60. comboBox_color_pal_points</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для точек</p></body></html><br><br>

<a id="w61"></a>
<b>61. pushButton_HEX_box</b> (QPushButton)<br>
...
<a id="w62"></a>
<b>62. pushButton_HEX_points</b> (QPushButton)<br>
...
<a id="w63"></a>
<b>63. comboBox_fonts</b> (QComboBox)<br>
Шрифт для подписей на графиках<br><br>

<a id="w64"></a>
<b>64. spinBox_x_label</b> (QSpinBox)<br>
Размер шрифта подписи X<br><br>

<a id="w65"></a>
<b>65. spinBox_y_label</b> (QSpinBox)<br>
Размер шрифта подписи Y<br><br>

<a id="w66"></a>
<b>66. btn_plot_and_save_figs</b> (QPushButton)<br>
...
<a id="w67"></a>
<b>67. path_for_plot</b> (QLineEdit)<br>
Путь к папке с excel файлом<br><br>

<a id="w68"></a>
<b>68. comboBox</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w69"></a>
<b>69. check_box_figs_all_sheets</b> (QCheckBox)<br>
Произвести обработку по всем листам в excel файле?<br><br>

<a id="w70"></a>
<b>70. comboBox_figs_sheets</b> (QComboBox)<br>
Название листа в excel файле -- подставится автоматически. Надо только выбрать<br><br>

<a id="w71"></a>
<b>71. comboBox_2</b> (QComboBox)<br>
<html><head/><body><p>Название столбца для категориальных групп.</p><p>Это может быть любая колонка, где есть определенные категории.</p><p>К примеру, &quot;Пол&quot;.</p></body></html><br><br>

<a id="w72"></a>
<b>72. checkBox_point_comma_separator</b> (QCheckBox)<br>
Разделитель значений на графике запятая?<br><br>

<a id="w73"></a>
<b>73. check_box_plot</b> (QCheckBox)<br>
<html><head/><body><p>Построить график box plot, в котором представлены разные категории?</p><p>В отдельной вкладке внизу можно изменить некоторые настройки построения графика.</p></body></html><br><br>

<a id="w74"></a>
<b>74. check_corr_matrix</b> (QCheckBox)<br>
<html><head/><body><p>Построить график корреляционной матрицы? Одна матрица на каждую категорию.</p><p>В отдельной вкладке внизу можно изменить некоторые настройки построения графика.</p></body></html><br><br>

<a id="w75"></a>
<b>75. check_corr_figs</b> (QCheckBox)<br>
<html><head/><body><p>Построить корреляционный график, где цветами будут выделены категории?</p><p>В отдельной вкладке внизу можно изменить некоторые настройки построения графика.</p></body></html><br><br>

<a id="w76"></a>
<b>76. check_box_pairplot</b> (QCheckBox)<br>
<html><head/><body><p>Построить матрицу рассеяния, где цветами будут выделены категории?</p><p>В отдельной вкладке внизу можно изменить некоторые настройки построения графика.</p></body></html><br><br>

<a id="w77"></a>
<b>77. check_jointplot</b> (QCheckBox)<br>
<html><head/><body><p>Построить график распределение по двум параметрам?</p><p>В отдельной вкладке внизу можно изменить некоторые настройки построения графика.</p></body></html><br><br>

<a id="w78"></a>
<b>78. check_corr_one_parameter</b> (QCheckBox)<br>
<html><head/><body><p>Построить корреляцию одного параметра? </p><p>То есть строится корреляция между выбранной колонки и всеми остальными.</p><p>Строится отдельно от других графиков. </p><p>В отдельной вкладке внизу можно изменить некоторые настройки построения графика.</p></body></html><br><br>

<a id="w79"></a>
<b>79. comboBox_color_pal_box</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для box</p></body></html><br><br>

<a id="w80"></a>
<b>80. comboBox_color_pal_points</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для точек</p></body></html><br><br>

<a id="w81"></a>
<b>81. pushButton_HEX_box</b> (QPushButton)<br>
<html><head/><body><p>Возможно делать кастомные цвета для box.</p><p>Для этого выберайте итерационно цвета в палитре.</p><p>В панеле слева будет формироваться строка, которая будет использована для создания палитры.</p></body></html><br><br>

<a id="w82"></a>
<b>82. pushButton_HEX_points</b> (QPushButton)<br>
<html><head/><body><p>Возможно делать кастомные цвета для точек.</p><p>Для этого выберайте итерационно цвета в палитре.</p><p>В панеле слева будет формироваться строка, которая будет использована для создания палитры.</p></body></html><br><br>

<a id="w83"></a>
<b>83. comboBox_fonts</b> (QComboBox)<br>
Шрифт для подписей на графиках<br><br>

<a id="w84"></a>
<b>84. spinBox_x_label</b> (QSpinBox)<br>
Размер шрифта подписи X<br><br>

<a id="w85"></a>
<b>85. spinBox_y_label</b> (QSpinBox)<br>
Размер шрифта подписи Y<br><br>

<a id="w86"></a>
<b>86. btn_plot_and_save_figs</b> (QPushButton)<br>
Построить все графики и сохранить их в соответствующих папках<br><br>
...
<a id="w87"></a>
<b>87. comboBox_color_pal_box</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для box</p></body></html><br><br>

<a id="w88"></a>
<b>88. comboBox_color_pal_points</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для точек</p></body></html><br><br>

<a id="w89"></a>
<b>89. pushButton_HEX_box</b> (QPushButton)<br>
<html><head/><body><p>Возможно делать кастомные цвета для box.</p><p>Для этого выберайте итерационно цвета в палитре.</p><p>В панеле слева будет формироваться строка, которая будет использована для создания палитры.</p></body></html><br><br>

<a id="w90"></a>
<b>90. pushButton_HEX_points</b> (QPushButton)<br>
<html><head/><body><p>Возможно делать кастомные цвета для точек.</p><p>Для этого выберайте итерационно цвета в палитре.</p><p>В панеле слева будет формироваться строка, которая будет использована для создания палитры.</p></body></html><br><br>

<a id="w91"></a>
<b>91. comboBox_fonts</b> (QComboBox)<br>
Шрифт для подписей на графиках<br><br>

<a id="w92"></a>
<b>92. spinBox_x_label</b> (QSpinBox)<br>
Размер шрифта подписи X<br><br>

<a id="w93"></a>
<b>93. spinBox_y_label</b> (QSpinBox)<br>
Размер шрифта подписи Y<br><br>
...
<a id="w94"></a>
<b>94. comboBox_color_pal_box</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для box</p></body></html><br><br>

<a id="w95"></a>
<b>95. comboBox_color_pal_points</b> (QComboBox)<br>
<html><head/><body><p>Цветовая палитра для точек</p></body></html><br><br>

<a id="w96"></a>
<b>96. pushButton_HEX_box</b> (QPushButton)<br>
<html><head/><body><p>Возможно делать кастомные цвета для box.</p><p>Для этого выберайте итерационно цвета в палитре.</p><p>В панеле слева будет формироваться строка, которая будет использована для создания палитры.</p></body></html><br><br>

<a id="w97"></a>
<b>97. pushButton_HEX_points</b> (QPushButton)<br>
<html><head/><body><p>Возможно делать кастомные цвета для точек.</p><p>Для этого выберайте итерационно цвета в палитре.</p><p>В панеле слева будет формироваться строка, которая будет использована для создания палитры.</p></body></html><br><br>

<a id="w98"></a>
<b>98. comboBox_fonts</b> (QComboBox)<br>
Шрифт для подписей на графиках<br><br>

<a id="w99"></a>
<b>99. spinBox_x_label</b> (QSpinBox)<br>
Размер шрифта подписи X<br><br>

<a id="w100"></a>
<b>100. spinBox_y_label</b> (QSpinBox)<br>
Размер шрифта подписи Y<br><br>
...
<a id="w101"></a>
<b>101. check_sort_or_not</b> (QCheckBox)<br>
Упорядочить значения в группе? Используется базовая сортировка<br><br>

<a id="w102"></a>
<b>102. check_sort_or_not_ascending</b> (QCheckBox)<br>
Упорядочить значения в группе по возрастанию?<br><br>

<a id="w103"></a>
<b>103. order_box_plot</b> (QLineEdit)<br>
...
<a id="w104"></a>
<b>104. check_stat_znachimost</b> (QCheckBox)<br>
Рассчитать статистическую значимость?<br><br>

<a id="w105"></a>
<b>105. spinBox_size_stat_znachimost</b> (QSpinBox)<br>
Шрифт значков статистической значимости<br><br>

<a id="w106"></a>
<b>106. comboBox_box_plot_sign_stat_znachimost</b> (QComboBox)<br>
...
<a id="w107"></a>
<b>107. spinBox_max_n_stars</b> (QSpinBox)<br>
...
<a id="w110"></a>
<b>110. comboBox_correlation_figs_matrix</b> (QComboBox)<br>
<html><head/><body><p>Метод расчета корреляций: Пирсон, Спирмен или Кендал.</p></body></html><br><br>

<a id="w111"></a>
<b>111. comboBox_correlation_color_map_for_figs</b> (QComboBox)<br>
Цветовая схема для корреляционной матрицы.<br><br>

<a id="w112"></a>
<b>112. corr_mat_figsize</b> (QDoubleSpinBox)<br>
...
<a id="w122"></a>
<b>122. check_pairplot</b> (QCheckBox)<br>
...
<a id="w123"></a>
<b>123. comboBox_color_jointplot</b> (QComboBox)<br>
Цветовая палитра для графика распределение по двум параметрам.<br><br>

<a id="w124"></a>
<b>124. comboBox_pairplot_jointplot</b> (QComboBox)<br>
Возможные настройки по отображению распределений.<br><br>

<a id="w125"></a>
<b>125. comboBox_style_jointplot</b> (QComboBox)<br>
Стиль графика. Используются стили seaborn.<br><br>

<a id="w126"></a>
<b>126. spinBox_point_size_for_jointplot</b> (QSpinBox)<br>
...
<a id="w127"></a>
<b>127. comboBox_correlation_one_parameter</b> (QComboBox)<br>
Метод расчета корреляций: Пирсон, Спирмен или Кендал.<br><br>

<a id="w128"></a>
<b>128. doubleSpinBox_size_for_one_correlation</b> (QDoubleSpinBox)<br>
Относительный размер шрифта для корреляции одного параметра.<br><br>

<a id="w129"></a>
<b>129. doubleSpinBox_one_correlation</b> (QDoubleSpinBox)<br>
Отсечка по корреляциям. Все корреляции, которые ниже заданного числа, не будут учитываться.<br><br>

<a id="w130"></a>
<b>130. check_corr_one_parameter_plot_sep_wind</b> (QCheckBox)<br>
...
<a id="w133"></a>
<b>133. norm_data</b> (QLineEdit)<br>
...
<a id="w150"></a>
<b>150. path_for_pivot_table</b> (QLineEdit)<br>
Путь к папке, где лежит(ат) excel файл(ы) для сводных таблиц.<br><br>

<a id="w151"></a>
<b>151. comboBox_pivot_table</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w152"></a>
<b>152. comboBox_pivot_table_excel_sheet</b> (QComboBox)<br>
Название листа в excel файле -- подставится автоматически. Надо только выбрать<br><br>

<a id="w153"></a>
<b>153. comboBox_pivot_hue</b> (QComboBox)<br>
Выберете столбец для групп. Это категориальная группа. К примеру, "Пол".<br><br>

<a id="w154"></a>
<b>154. spinBox_pivot_table</b> (QSpinBox)<br>
Округлить значения до выбранного знака после запятой.<br><br>

<a id="w155"></a>
<b>155. comboBox_sd_or_se_pivot</b> (QComboBox)<br>
Погрешность SD или SE.<br><br>

<a id="w156"></a>
<b>156. btn_plot_and_save_pivot_table</b> (QPushButton)<br>
Получить и сохранить сводную таблицу.<br><br>

<a id="w157"></a>
<b>157. comboBox_correlation_person_or_not</b> (QComboBox)<br>
<html><head/><body><p>Метод расчета корреляций: Пирсон, Спирмен или Кендал.</p></body></html><br><br>

<a id="w158"></a>
<b>158. check_color_for_corr_pivot</b> (QCheckBox)<br>
Выделить ячейки цветом?<br><br>

<a id="w159"></a>
<b>159. comboBox_correlation_color_map</b> (QComboBox)<br>
Цветовая схема для корреляционной матрицы?<br><br>

<a id="w160"></a>
<b>160. btn_plot_and_save_corr_table</b> (QPushButton)<br>
...
<a id="w161"></a>
<b>161. comboBox_index_data_or_raw</b> (QComboBox)<br>
...
<a id="w162"></a>
<b>162. btn_save_pivot_or_melt</b> (QPushButton)<br>
...
<a id="w163"></a>
<b>163. path_for_catplot</b> (QLineEdit)<br>
Путь к папке с excel файлом<br><br>

<a id="w164"></a>
<b>164. comboBox_excel_catplot</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w165"></a>
<b>165. comboBox_excel_sheet_catplot</b> (QComboBox)<br>
Название листа в excel файле -- подставится автоматически. Надо только выбрать<br><br>

<a id="w166"></a>
<b>166. comboBox_catplot_x</b> (QComboBox)<br>
<html><head/><body><p>Основная группа, в которой представлены категории.</p><p>К примеру, группа &quot;Диагноз&quot;.</p></body></html><br><br>

<a id="w167"></a>
<b>167. comboBox_catplot_form_x</b> (QComboBox)<br>
<html><head/><body><p>Явно привести тип для группы по оси X в заданный тип.</p></body></html><br><br>

<a id="w168"></a>
<b>168. comboBox_catplot_y</b> (QComboBox)<br>
...
<a id="w171"></a>
<b>171. comboBox_catplot_form_hue</b> (QComboBox)<br>
<html><head/><body><p>Явно привести тип для подгруппы в заданный тип.</p></body></html><br><br>

<a id="w172"></a>
<b>172. doubleSpinBox_catplot</b> (QDoubleSpinBox)<br>
Относительный размер шрифта.<br><br>

<a id="w173"></a>
<b>173. comboBox_color_catplot</b> (QComboBox)<br>
Цветовая палитра для catplot.<br><br>

<a id="w174"></a>
<b>174. comboBox_template_catplot</b> (QComboBox)<br>
...
<a id="w175"></a>
<b>175. comboBox_catplot_SD_or_not</b> (QComboBox)<br>
Погрешности для вывода: SD, SE, доверительный или перцентильный интервал.<br><br>

<a id="w176"></a>
<b>176. spinBox_catplot_angle</b> (QSpinBox)<br>
Вращать подписи на заданный угол.<br><br>

<a id="w177"></a>
<b>177. check_stat_znachimost_catplot</b> (QCheckBox)<br>
Рассчитать статистическую значимость?<br><br>

<a id="w178"></a>
<b>178. comboBox_stat_test_catplot</b> (QComboBox)<br>
Статистический тест для расчета статистической значимости для catplot.<br><br>

<a id="w179"></a>
<b>179. check_stat_znachimost_catplot_inside_subgroup</b> (QCheckBox)<br>
Рассчитать статистическую значимость только внутри подгруппы?<br><br>

<a id="w180"></a>
<b>180. comboBox_catplot_stat_formatt</b> (QComboBox)<br>
...
<a id="w183"></a>
<b>183. path_for_RheoScan_describe</b> (QLineEdit)<br>
...
<a id="w184"></a>
<b>184. toolButton_RheoScan</b> (QToolButton)<br>
<html><head/><body><p>Выбрать папку, в которой лежат excel файлы интерактивно.</p></body></html><br><br>

<a id="w185"></a>
<b>185. comboBox_RheoScan_describe</b> (QComboBox)<br>
...
<a id="w186"></a>
<b>186. RheoScan_describe_mask_sheets</b> (QLineEdit)<br>
...
<a id="w187"></a>
<b>187. btn_RheoScan_describe_file_or_files</b> (QPushButton)<br>
<html><head/><body><p>Рассчитать средние значения и SD для файла или файлов и сохранить данные в excel файл.</p></body></html><br><br>

<a id="w188"></a>
<b>188. path_for_rheoscan_report</b> (QLineEdit)<br>
Путь к папке с excel файлом<br><br>

<a id="w189"></a>
<b>189. comboBox_rheoscan_report</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w190"></a>
<b>190. calendarWidget_rheoscan_report</b> (QCalendarWidget)<br>
Дата измерения.<br><br>

<a id="w191"></a>
<b>191. rheoscan_report_name_exp</b> (QLineEdit)<br>
<html><head/><body><p>ФИО того, кто проводил эксперимент.</p></body></html><br><br>

<a id="w192"></a>
<b>192. rheoscan_report_name_process</b> (QLineEdit)<br>
<html><head/><body><p>ФИО того, кто обрабатывал данные.</p></body></html><br><br>

<a id="w193"></a>
<b>193. rheoscan_report_parameters_dict</b> (QPlainTextEdit)<br>
...
<a id="w194"></a>
<b>194. btn_make_rheoscan_report</b> (QPushButton)<br>
...
<a id="w195"></a>
<b>195. path_for_dop_stat</b> (QLineEdit)<br>
Путь к папке с excel файлом<br><br>

<a id="w196"></a>
<b>196. comboBox_excel_dop_stat</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w197"></a>
<b>197. comboBox_excel_sheet_dop_stat</b> (QComboBox)<br>
<html><head/><body><p>Название листа в excel файле -- подставится автоматически. Надо только выбрать</p></body></html><br><br>

<a id="w198"></a>
<b>198. comboBox_dop_stat_x</b> (QComboBox)<br>
Колонка №1/2 для выбора.<br><br>

<a id="w199"></a>
<b>199. comboBox_dop_stat_y</b> (QComboBox)<br>
Колонка №2/2 для выбора.<br><br>

<a id="w200"></a>
<b>200. comboBox_stat_test_dop_stat</b> (QComboBox)<br>
...
<a id="w201"></a>
<b>201. comboBox_alter_hep_dop_stat</b> (QComboBox)<br>
Альтернативная гипотеза.<br><br>

<a id="w202"></a>
<b>202. p_value_dop_stat</b> (QLineEdit)<br>
<html><head/><body><p>Выводимое значение p.</p></body></html><br><br>

<a id="w203"></a>
<b>203. btn_dop_stat_calc</b> (QPushButton)<br>
...
<a id="w204"></a>
<b>204. path_for_dop_stat</b> (QLineEdit)<br>
Путь к папке с excel файлом<br><br>

<a id="w205"></a>
<b>205. comboBox_excel_dop_stat</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w206"></a>
<b>206. comboBox_excel_sheet_dop_stat</b> (QComboBox)<br>
<html><head/><body><p>Название листа в excel файле -- подставится автоматически. Надо только выбрать</p></body></html><br><br>

<a id="w207"></a>
<b>207. comboBox_dop_stat_x</b> (QComboBox)<br>
Колонка №1/2 для выбора.<br><br>

<a id="w208"></a>
<b>208. comboBox_dop_stat_y</b> (QComboBox)<br>
Колонка №2/2 для выбора.<br><br>

<a id="w209"></a>
<b>209. comboBox_stat_test_dop_stat</b> (QComboBox)<br>
<html><head/><body><p>Статистический тест для выбора.</p><p>Не используйте пермутационные тесты, если у вас много значений в колонках.</p></body></html><br><br>

<a id="w210"></a>
<b>210. comboBox_alter_hep_dop_stat</b> (QComboBox)<br>
Альтернативная гипотеза.<br><br>

<a id="w211"></a>
<b>211. p_value_dop_stat</b> (QLineEdit)<br>
<html><head/><body><p>Выводимое значение p.</p></body></html><br><br>

<a id="w212"></a>
<b>212. btn_dop_stat_calc</b> (QPushButton)<br>
Рассчитать статистическую значимость между двумя столбцами.<br><br>
...
<a id="w213"></a>
<b>213. path_for_excel_cluster</b> (QLineEdit)<br>
Путь к папке с excel файлом для кластеризации признаков по корреляции.<br><br>

<a id="w214"></a>
<b>214. comboBox_cluster_file</b> (QComboBox)<br>
Название excel файла -- подставится автоматически. Надо только выбрать<br><br>

<a id="w215"></a>
<b>215. comboBox_cluster_excel_sheet</b> (QComboBox)<br>
Название листа в excel файле -- подставится автоматически. Надо только выбрать<br><br>

<a id="w216"></a>
<b>216. spinBox_cluster_n</b> (QSpinBox)<br>
Кол-во класстеров для выделения.<br><br>

<a id="w217"></a>
<b>217. comboBox_cluster_coord</b> (QComboBox)<br>
Координаты пространства для 2D отображения: MDS или PSA.<br><br>

<a id="w218"></a>
<b>218. spinBox_cluster_buble_size</b> (QSpinBox)<br>
Размер пузырьков на графике.<br><br>

<a id="w219"></a>
<b>219. btn_cluster_save_file</b> (QPushButton)<br>
...
<a id="w220"></a>
<b>220. lineEdit_json_load</b> (QLineEdit)<br>
Полный путь к JSON файлу<br><br>

<a id="w221"></a>
<b>221. btn_json_load</b> (QPushButton)<br>
